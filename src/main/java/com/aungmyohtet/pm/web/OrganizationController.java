...
public class OrganizationController {
	...
	@ResponseBody
	public List<UserDto> getOrganizationMembers(@PathVariable("organizationName") String organizationName,
			Model model) {
		/*
		 * List<User> users = new ArrayList<>(); List<OrganizationMember>
		 * members = organizationService.findMembersByOrganization(id); for
		 * (OrganizationMember member : members) { users.add(member.getUser());
		 * }
		 */
	...
	public String addMemberToOrganization(@PathVariable("organizationName") String organizationName, Model model,
	...
	public List<OrganizationDto> list(Model model) {
		...
		return organizations.stream().map(organization -> organizationService.convertToDto(organization))
	...
	@ResponseBody
	public List<ProjectDto> getOrganizationProjects(@PathVariable("organizationName") String organizationName,
			Model model) {
	...
	public String showOrganizationProjects(@PathVariable("organizationName") String organizationName, Model model) {
		List<Project> projects = organizationService.findProjectsByOrganization(organizationName);
		List<ProjectDto> projectDtos = projects.stream().map(project -> projectService.converToDto(project))
				.collect(Collectors.toList());
		model.addAttribute("organizationName", organizationName);
